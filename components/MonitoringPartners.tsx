  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-14 rounded-2xl border border-white/[0.08] bg-surface overflow-hidden shadow-[0_24px_64px_-12px_rgba(14,165,233,0.14)]">
          ...
          <div className="px-8 py-10 md:px-12 md:py-12">
            ...
            <p className="text-base text-white/55 leading-relaxed max-w-3xl mb-10">
              ...
              a unified AI security layer that autonomously patrols sites, deters threats in real time,
